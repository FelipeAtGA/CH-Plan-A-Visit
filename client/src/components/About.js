    ...
    return (
      ...
      <div className='aboutPageWrapper'>
        ...
        <div id="column2About" className='aboutPageDivs'>
          ...
          <h3 className='aboutPadding hoursOfOp'><a href='https://goo.gl/maps/tCRT7wRbm4B2' target="_blank" rel='noopener noreferrer'>2 E 91<sup>st</sup>&nbsp; St.<br />New York, NY 10128</a></h3>
        </div>
